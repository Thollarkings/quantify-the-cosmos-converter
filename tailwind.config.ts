	...
	theme: {
		...
		extend: {
			...
			keyframes: {
				...
				'glow': {
					'0%': {
						boxShadow: '0 0 5px rgba(123, 104, 238, 0.5)'
					},
					'50%': {
			...
			backgroundImage: {
				'gradient-converter': 'linear-gradient(to bottom, rgba(6, 0, 36, 0.95), rgba(15, 0, 102, 0.85))'
			},
			boxShadow: {
				'cosmic': '0 0 15px rgba(123, 104, 238, 0.7)'
			}
		}
	},
